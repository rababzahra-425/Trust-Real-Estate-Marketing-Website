...
const channels = [
  ...
  {
    id: 'email', label: 'Email', value: 'info@trustmarketing.pk', sub: 'We reply within 24 hours', href: 'mailto:info@trustmarketing.pk',
      ...
      <header className="cp-header">
        <div className="cp-header-bg">
          <Image src="/contact_header.png"
            alt="Trust Real Estate client relations department representing expert property consultancy in Sahiwal" fill priority className="cp-header-bg-img" sizes="100vw" style={{ objectFit: 'cover' }} />
